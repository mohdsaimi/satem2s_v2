<x-forms.patch :action="route('frontend.user.profile.update')">
    ...
    <div class="form-group row">
        <label for="jawatan" class="col-md-3 col-form-label text-md-right">Jawatan</label>

        <div class="col-md-9">
            <input type="text" name="jawatan" id="jawatan" class="form-control" placeholder="{{ __('Jawatan') }}" value="{{ old('jawatan') ?? $logged_in_user->jawatan ?? null }}" required />
        </div>
    </div><!--form-group-->
