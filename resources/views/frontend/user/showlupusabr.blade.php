...
@section('title', __('Papar Permohonan Pelupusan Aset Alih (ABR)'))
            ...
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="card-title mb-0">
                        Papar Permohonan Pelupusan Aset Alih (ABR)
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            <input type="text" class="form-control" id="prestasi" name="prestasi" value="{{ $abrlupus->prestasi }}" disabled>
                        </div><!--col-->

                        <label class="col-md-3 col-form-label"><b>Jumlah Kos Penyelenggaraan Terdahulu</b></label>
                        <div class="col-md">
                            <input type="text" class="form-control" id="kod_dulu" name="kod_dulu" value="{{ $abrlupus->kod_dulu }}" disabled>
                        </div><!--col-->

                        <label class="col-md-1 col-form-label"><b>Nilai Semasa</b></label>
                        <div class="col-md">
                            <input type="text" class="form-control" id="nilai_semasa" name="nilai_semasa" value="{{ $abrlupus->nilai_semasa }}" disabled>
                        </div><!--col-->

                        <label class="col-md col-form-label"><b>Tahun Pelupusan</b></label>
                            <div class="col-md">
                                <input type="text" class="form-control" id="tahun_lupus" name="tahun_lupus" value="{{ $abrlupus->tahun_lupus }}" disabled>
                        </div><!--col-->
