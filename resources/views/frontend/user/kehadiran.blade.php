                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 pull-right">
                        ...
                        <div class="btn-toolbar float-right">
                            <a class="btn btn-primary" target="_blank" href="{{ route('frontend.user.pdf_view',['term_1' => request('term_1'),'term_2' => request('term_2'), 'date' => request('date')]) }}">Export to PDF</a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <form action="{{ route('frontend.user.kehadiran') }}" method="GET" role="search">
                            ...
                            <div class="input-group">
                                ...
                                {{-- <input class="form-control mb-2 mr-sm-2" id="datepicker1" name="date" width="200"
                                    placeholder="YYYY/MM/DD" required>
