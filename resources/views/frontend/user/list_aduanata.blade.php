...
@section('title', __('Aduan Kerosakan ATA'))
        ...
        <div class="row">
            ...
            <div class="col-sm-6 pull-right">
                ...
                <div class="btn-toolbar float-right">
                    <a href="{{ route('frontend.user.atarosak_selesai') }}" class="btn btn-primary ml-1" data-toggle="tooltip" title="View"><i class="fas fa-eye"></i> Aduan Selesai</a>
                </div>
                ...
                <div class="btn-toolbar float-right">
                    <a href="{{ route('frontend.user.exportata') }}" class="btn btn-info ml-1" data-toggle="tooltip" title="Excel"><i class="fas fa-file-csv"></i></a>
                </div>

            </div><!--col-->

            <div class="col-sm-7">
                <form action="{{ route('frontend.user.list_aduanata') }}" method="GET" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('frontend.user.list_aduanata') }}">
