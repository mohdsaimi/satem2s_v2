    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-7">
                    <form action="{{ route('frontend.user.list_aduanhm') }}" method="GET" role="search">
                        ...
                        <div class="input-group">
                            ...
                            <a href="{{ route('frontend.user.list_aduanhm') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <a href="{{ route('frontend.user.showhmrosak',[$hmrosak,'term'=>request('term') ?? null]) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="show">
                                                    <i class="fas fa-eye"></i></a>

                                                <a href="{{ route('frontend.user.pdfhmrosak',$hmrosak) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Print">
