...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7">
                <form action="{{ route('frontend.user.strrosak_selesai') }}" method="GET" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('frontend.user.strrosak_selesai') }}">
                        ...
                        <tbody>
                            @foreach($strrosaks as $strrosak)
                                ...
                                <tr>
                                    ...
                                    <td style="text-transform:uppercase">{{ $strrosak->tarikh_mula ?? null}}</td>
                                    <td style="text-transform:uppercase">{{ $strrosak->tarikh_siap ?? null}}</td>
