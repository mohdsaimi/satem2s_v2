...
@section('title', __('Maklumat Aduan Kerosakan (ABR) - Selesai'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        Maklumat Aduan Kerosakan (ABR) - Selesai
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="tahun" value="{{ $abrrosak->tarikh_siap ?? null }}" disabled>
                        </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" style="font-weight: bold;" value="{{  $abrrosak->statusrosak->nama_status ?? null}}" disabled>
