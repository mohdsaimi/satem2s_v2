            ...
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="card-title mb-0">
                        Maklumat Aduan Kerosakan (ATA - Struktur)
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" {{-- id="nama_komponen" name="nama_komponen" --}} value="{{ $strrosak->lokasi->bangunan->nama_bangunan ?? null }}" disabled>
                        </div><!--col-->
                        <label class="col-md-2 col-form-label">Kod Dan Nama Ruang</label>
                        <div class="col-md">
                            <input type="text" class="form-control" {{-- id="no_1gfmas" name="no_1gfmas" --}} value="{{ $strrosak->lokasi->bangunan->kod_bangunan ?? null }}.{{ $strrosak->lokasi->aras ?? null }}.{{ $strrosak->lokasi->kod_lokasi ?? null }} - {{ $strrosak->lokasi->nama_lokasi ?? null}}" disabled>
                        </div><!--col-->
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Ulasan Kerosakan</label>
                            <div class="col-md">
                        ...
                        <label class="col-md-2 col-form-label">Status Semasa</label>
                            <div class="col-md-3">
                                <select class="form-control" name="status" style="text-transform:uppercase" disabled>
                                    <option value="{{ $strrosak->status}}" style="text-transform:uppercase">{{ $strrosak->statusrosak->nama_status ?? null}}</option>
                                </select>
