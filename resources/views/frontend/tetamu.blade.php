    ...
    <head>
        ...
        <style>
            ...
            .div-with-bg{
                /* resize: both;
                overflow: auto; */
                background-image: url('{{ asset('storage/IMAGES/drop_1.jpeg') }}');
                        ...
                        <div class="card border-danger  mb-5">
                            <div class="card text-center">
                                ...
                                @if ($senarai_suhu [2] != 0.00)
                                    ...
                                    <div class="card-body">
                                        <h1 style="font-size:3em;" class="card-title">Tuan/Puan</h1>
                                        <h1 style="font-size:3em;" class="card-title">{{ $senarai_vip [2] ?? null }}</h1>
                                        
                                            {{-- <p class="btn btn-success btn-lg">Suhu : {{ $senarai_suhu [1] ?? null }}</p> --}}
                                            <p class="btn btn-success btn-lg button" style="font-size:2.5em;">Masa : {{ date('H:i:s', strtotime($senarai_masa [2])) }}</p>
