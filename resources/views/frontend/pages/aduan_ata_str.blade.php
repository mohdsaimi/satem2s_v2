...
<form method="POST" action="{{ route('frontend.storestrrosak') }}" enctype="multipart/form-data">
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="nama_kekemasan" name="nama_kekemasan">
                        </div><!--col-->
                        <div class="col-md">
                            <p style="color:red;">* Sila masukkan nama kekemasan/lekapan seperti dinding, siling, lantai DLL yang memerlukan penyelenggaraan.</p>
                        </div><!--col-->
                    </div><!--form-group-->
