    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-7">
                    <form action="{{ route('frontend.pages.mohonlupusabr') }}" method="GET" role="search">
                        <div class="input-group">
                            ...
                            <a href="{{ route('frontend.pages.mohonlupusabr') }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                @if (!empty($tetapan->tetapan_bppa))
                                                    <a href="{{ route('frontend.pages.mohonlupusabr1',[$abr,'term'=>request('term') ?? null]) }}" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="mohon lupus">
