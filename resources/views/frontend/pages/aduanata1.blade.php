...
<div class="container py-4">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7">
                <form action="{{ route('frontend.pages.aduanata1') }}" method="GET" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('frontend.pages.aduanata1') }}">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>Aras</th>
                            <th>Nama Ruang</th>
                            <th style="text-align: center">Bil. DA.</th>
                            <th>Aduan Komponen</th>
                            <th style="text-align: center">Aduan Struktur/Kekemasan</th>
                        </tr>
                        </thead>
                        <tbody>
                            @foreach($lokasis as $lokasi)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">{{ $bil_DA->where('lokasi_bangunans_id',$lokasi->id)->count() ?? null}}</td>
                                    <td style="text-align: center">
                                        {{-- butang --}}
                                        <div class="btn-group btn-group-sm">

                                                @if ($bil_DA->where('lokasi_bangunans_id',$lokasi->id)->count() > 0)
                                                <a href="{{ route('frontend.pages.aduanata2',[$lokasi,'term'=>request('term'),'term1'=>request('term1') ?? null]) }}{{-- {{ route('frontend.pages.aduanata2',[$lokasi,'term'=>request('term'),'term1'=>request('term1') ?? null]) }} --}}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="aduan">
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <div class="btn-group btn-group-sm">
                                                ...
                                                <a href="{{ route('frontend.pages.aduan_ata_str',[$lokasi,'term'=>request('term'),'term1'=>request('term1') ?? null]) }}" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="aduan struktur">
