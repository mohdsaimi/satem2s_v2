    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-7">
                    <form action="{{ route('frontend.pages.mohonlupushm') }}" method="GET" role="search">
                        <div class="input-group">
                            ...
                            <a href="{{ route('frontend.pages.mohonlupushm') }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                @if (!empty($tetapan->tetapan_bppa))
                                                    <a href="{{ route('frontend.pages.mohonlupushm1',[$hartamodal,'term'=>request('term') ?? null]) }}" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="mohon lupus">
