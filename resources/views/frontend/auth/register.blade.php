                ...
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        <x-forms.post :action="route('frontend.auth.register')">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">Jawatan</label>

                                <div class="col-md-6">
                                    <input type="text" name="jawatan" id="jawatan" class="form-control" value="{{ old('jawatan') }}" placeholder="{{ __('Jawatan') }}" maxlength="100" required autofocus autocomplete="jawatan" />
                                </div>
                            </div><!--form-group-->
