...
<form method="POST" action="{{ route('admin.updatestrsyor', [$strrosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            ...
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control" name="tahun" value="{{ $strrosak->tahun ?? null }}" required>
