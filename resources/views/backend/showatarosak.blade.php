...
<form method="POST" action="{{ route('admin.updateatarosak', [$atarosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Keterangan</label>
                            <div class="col-md">
                                <textarea class="form-control" id="ulas_siasat" name="ulas_siasat" required>{{ $atarosak->ulas_siasat ?? null}}</textarea>
                            </div><!--col-->
                    </div>
