...
@section('title', __('Maklumat Syor Aduan Kerosakan (ABR)'))

@section('content')

<form method="POST" action="{{ route('admin.updatesyor2abr', [$abrrosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        Maklumat Syor Aduan Kerosakan (ABR)
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            <input type="text" class="form-control" {{-- id="jenama" name="jenama" --}} value="{{ $abrrosak->abr->jenama ?? null}}" disabled>
                        </div><!--col-->

                        <label class="col-md-1 col-form-label">Kod Lokasi Asal</label>
                        <div class="col-sd">
                            <input type="text" class="form-control" {{-- id="kod_lokasi_asal" name="kod_lokasi_asal" --}} value="{{ $abrrosak->abr->kod_lokasi_asal ?? null}}" disabled>
                        </div><!--col-->
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Jumlah Kos Penyelenggaraan Terdahulu</b></label>
                            <div class="col-md-1">
                                <input type="text" class="form-control" id="kos_dulu" name="kos_dulu" value="{{ $abrrosak->kos_dulu ?? null}}" disabled>
                            </div><!--col-->

                            <label class="col-md-2 col-form-label"><b>Anggaran Kos Penyelenggaraan</b></label>
                            <div class="col-md-1">
                                <input type="text" class="form-control" id="kos_anggar" name="kos_anggar" value="{{ $abrrosak->kos_anggar ?? null}}" disabled>
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Ulasan/Kerja yang dilakukan/Cadangan</b></label>
                            <div class="col-md">
                                <textarea class="form-control" id="nota_tindakan" name="nota_tindakan" disabled>{{ $abrrosak->nota_tindakan ?? null}}</textarea>
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" value="{{ $abrrosak->statusrosak->nama_status ?? null}}" disabled>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Syor Dan Ulasan</b></label>
                            <div class="col-md">
                                <textarea class="form-control" id="syor" name="syor" disabled>{{ $abrrosak->syor ?? null}}</textarea>
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            ...
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control" name="tahun" value="{{ $abrrosak->tahun ?? null }}" disabled>
