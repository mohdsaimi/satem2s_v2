...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7">
                <form action="{{ route('admin.atarosak_selesai') }}" method="GET" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('admin.atarosak_selesai') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.showatarosak_selesai',[$atarosak,'term'=>request('term') ?? null]) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="show">
