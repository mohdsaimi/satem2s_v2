...
<body>
    ...
    <div class="row mt-4">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $hmrosak->hartamodal->jenis ?? null}} / {{ $hmrosak->hartamodal->jenama ?? null}}</td>
                            </tr>
                            <tr>
                                <td style="width:10px">2.</td>
                                <td style="width:180px">Nombor Siri Pendaftaran Aset/ Komponen</td>
                                <td style="width:5px">:</td>
                                <td>{{ $hmrosak->hartamodal->no_siri_pendaftaran ?? null}}</td>
                            </tr>
                            <tr>
                                <td style="width:10px">3.</td>
                                <td style="width:180px">Pengguna Terakhir</td>
                                <td style="width:5px">:</td>
                                <td>{{ $hmrosak->penguna_akhir ?? null}}</td>
                            </tr>
                            <tr>
                                <td style="width:10px">4.</td>
                                <td style="width:180px">Tarikh Kerosakan</td>
                                <td style="width:5px">:</td>
                                <td>{{ date('d-m-Y', strtotime($hmrosak->tarikh_rosak ?? null)) }}</td>
                            </tr>
                            <tr>
                                <td style="width:10px">5.</td>
                                <td style="width:180px">Perihal Kerosakan</td>
                                <td style="width:5px">:</td>
                                <td>{{ $hmrosak->prihal_rosak ?? null}}</td>
                            </tr>
                            <tr>
                                <td style="width:10px">6.</td>
                                <td style="width:180px">Nama Dan Jawatan</td>
                                <td style="width:5px">:</td>
                                <td>{{ $hmrosak->kakitangan->nama ?? null}} ( {{ $hmrosak->kakitangan->jawatan ?? null}} - {{ $hmrosak->kakitangan->gred ?? null}} )</td>
                            </tr>
                            <tr>
                                <td style="width:10px">7.</td>
                                <td style="width:180px">Tarikh</td>
                                <td style="width:5px">:</td>
                                <td>{{ date('d-m-Y', strtotime($hmrosak->tarikh_aduan ?? null)) }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                @if (empty ($hmrosak->kos_anggar))
                                    <td></td>
                                @else
                                    <td>RM {{ number_format($hmrosak->kos_anggar ?? null, 2) }}</td>
                                @endif
                            ...
                            <tr>
                                ...
                                <td style="width:5px">:</td>
                                <td>{{ $hmrosak->syor ?? null }}</td>
                            </tr>
                            <tr>
                                <td style="width:10px">11.</td>
                                <td style="width:180px">Nama Dan Jawatan</td>
                                <td style="width:5px">:</td>
                                @if (empty($hmrosak->user_syor))
                                    <td></td>
                                @else
                                    <td>{{ $hmrosak->nama_syor->name ?? null }} ({{ $hmrosak->nama_syor->jawatan ?? null }})</td>
                                @endif
                            ...
                            <tr>
                                ...
                                <td style="width:180px">Tarikh</td>
                                <td style="width:5px">:</td>
                                @if (empty($hmrosak->tarikh_syor))
                                    <td></td>
                                @else
                                    <td>{{ date('d-m-Y', strtotime($hmrosak->tarikh_syor ?? null)) }}</td>
                                @endif
                            ...
                            <tr>
                                <td colspan="4">PIC : {{ $hmrosak->nama_1->nama ?? null}}</td>
                            </tr>
        ...
        <table>
            <thead>
                <tr>
                    <th colspan="4"><b>Gambar Aduan Kerosakan {{ $hmrosak->hartamodal->no_siri_pendaftaran ?? null}}</b></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td><img src="{{ public_path('storage/HM/'.$hmrosak->pic_1) }}" class="rounded mx-auto d-block" height="250px;" alt="pic"></td>
                </tr>

                @if (!empty($hmrosak->pic_2))
                <tr>
                    <td><img src="{{ public_path('storage/HM/'.$hmrosak->pic_2) }}" class="rounded mx-auto d-block" height="250px;" alt="pic"></td>
                </tr>
                @endif
                @if (!empty($hmrosak->pic_3))
                <tr>
                    <td><img src="{{ public_path('storage/HM/'.$hmrosak->pic_3) }}" class="rounded mx-auto d-block" height="250px;" alt="pic"></td>
                </tr>
                @endif
