...
@section('title', __('Maklumat Aduan Kerosakan (ATA-Struktur)'))

@section('content')

<form method="POST" action="{{ route('admin.updatestrrosaktin', [$strrosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        Maklumat Tindakan Aduan Kerosakan (ATA-Struktur)
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        <label class="col-md-1 col-form-label"></label>
                            <div class="col-md-4">
                                <b>Jenis Alat Ganti</b>
                            </div><!--col-->
                            
                            <div class="col-md-2">
                                <b>Harga Alat Ganti/Stok</b>
                            </div><!--col-->
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-1 col-form-label"><b>1.</b></label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="jenis_1" name="jenis_1" value="{{ $strrosak->jenis_1 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="harga_1" name="harga_1" value="{{ $strrosak->harga_1 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-1">
                                <input type="text" class="form-control" id="kuantiti_1" name="kuantiti_1" value="{{ $strrosak->kuantiti_1 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="jumlah_1" name="jumlah_1" value="{{ $strrosak->jumlah_1 ?? null}}">
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-1 col-form-label"><b>2.</b></label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="jenis_2" name="jenis_2" value="{{ $strrosak->jenis_2 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="harga_2" name="harga_2" value="{{ $strrosak->harga_2 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-1">
                                <input type="text" class="form-control" id="kuantiti_2" name="kuantiti_2" value="{{ $strrosak->kuantiti_2 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="jumlah_2" name="jumlah_2" value="{{ $strrosak->jumlah_2 ?? null}}">
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-1 col-form-label"><b>3.</b></label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="jenis_3" name="jenis_3" value="{{ $strrosak->jenis_3 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="harga_3" name="harga_3" value="{{ $strrosak->harga_3 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-1">
                                <input type="text" class="form-control" id="kuantiti_3" name="kuantiti_3" value="{{ $strrosak->kuantiti_3 ?? null}}">
                            </div><!--col-->
                        
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="jumlah_3" name="jumlah_3" value="{{ $strrosak->jumlah_3 ?? null}}">
                            </div><!--col-->
                    </div>

                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Perihal Kerja / Tindakan</b></label>
                            <div class="col-md">
                                <textarea class="form-control" id="perihal_kerja" name="perihal_kerja">{{ $strrosak->perihal_kerja ?? null}}</textarea>
                            </div><!--col-->
                    </div>
