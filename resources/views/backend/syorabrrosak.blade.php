...
<form method="POST" action="{{ route('admin.updatesyorabr', [$abrrosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Syor Dan Ulasan</b></label>
                            <div class="col-md">
                                <textarea class="form-control" id="syor" name="syor" required>{{ $abrrosak->syor ?? null}}</textarea>
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            ...
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control" name="tahun" value="{{ $abrrosak->tahun ?? null }}" required>
