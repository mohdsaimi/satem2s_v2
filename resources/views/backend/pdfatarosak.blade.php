    ...
    <div class="row mt-4">
        ...
        <div class="table-responsive">
            ...
            <table class="table" style="border:1px solid; width:100%">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="8"><u>{{ $atarosak->asetalih->nama_komponen ?? null}}</u><br>{{ $atarosak->prihal_rosak ?? null }}</td>
                </tr>
                ...
                <tr>
                    <td style="width:5%; text-align:center; border-left:1px solid">
                        @if (!empty($atarosak->jenis_3))
                            3
                        @else
                            &nbsp;
                        @endif
                ...
                <tr>
                    ...
                    <td colspan="6">: {{ $atarosak->perihal_kerja ?? null }}</td>
                </tr>
                <tr>
                    <td colspan="9">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">: {{ date('d-m-Y', strtotime($atarosak->tarikh_mula ?? null)) }}</td>
                    <td colspan="2">Tarikh & Masa Siap</td>
                    <td colspan="2">: @if (empty($atarosak->tarikh_siap))
                        
                    @else
                        {{ date('d-m-Y', strtotime($atarosak->tarikh_siap ?? null)) }}
                    @endif
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="4">Pengesahan Oleh Pegawai Operasi Fasiliti</td>
                </tr>
                <tr>
                    <td colspan="9">&nbsp;</td>
                </tr>
