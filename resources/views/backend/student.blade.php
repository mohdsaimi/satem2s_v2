...
@section('title', __('Pengurusan Pelajar'))
        ...
        <div class="row">
            ...
            <div class="col-sm-7 pull-right">
                ...
                <div class="btn-toolbar float-right">
                    <a href="{{ route('admin.createstudent') }}" class="btn btn-success ml-1" data-toggle="tooltip" title="Create"><i class="fas fa-plus-circle"></i></a>
                </div>

            </div><!--col-->

            <div class="col-sm-7">
                <form action="{{ route('admin.student') }}" method="GET" role="search">
                        ...
                        <tbody>
                            @foreach($students as $student)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.edit_status_student',[$student,'term'=>request('term') ?? null]) }}" class="btn btn-outline-warning btn-sm" data-toggle="tooltip" data-placement="top" title="{{ $student->status->nama_status ?? null}}">
                                            {{ $student->status->nama_status ?? null}}
                                        </a>
                                    </td>
                                    <td>
                                        ...
                                        <form action="{{ route('admin.destroystudent', [$student,'term'=>request('term') ?? null]) }}" method="POST">
                                            <div class="btn-group btn-group-sm" {{-- aria-label="@lang('labels.backend.access.users.user_actions')" --}}>
                                                <a href="{{ route('admin.showstudent',[$student,'term'=>request('term') ?? null]) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="show">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.editstudent',[$student,'term'=>request('term') ?? null]) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="edit">
