...
@section('title', __('Edit Permohonan Pelupusan Aset Alih (Harta Modal)'))

@section('content')

<form method="POST" action="{{ route('admin.update_lupus', [$hmlupus,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="card-title mb-0">
                        Edit Permohonan Pelupusan Aset Alih (Harta Modal)
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md">
                            <input type="text" class="form-control" id="prestasi" name="prestasi" value="{{ $hmlupus->prestasi }}" required>
                        </div><!--col-->

                        <label class="col-md-3 col-form-label"><b>Jumlah Kos Penyelenggaraan Terdahulu</b></label>
                        <div class="col-md">
                            <input type="text" class="form-control" id="kod_dulu" name="kod_dulu" value="{{ $hmlupus->kod_dulu }}">
                        </div><!--col-->

                        <label class="col-md-1 col-form-label"><b>Nilai Semasa</b></label>
                        <div class="col-md">
                            <input type="text" class="form-control" id="nilai_semasa" name="nilai_semasa" value="{{ $hmlupus->nilai_semasa }}" required>
                        </div><!--col-->

                        <label class="col-md col-form-label"><b>Tahun Pelupusan</b></label>
                            <div class="col-md">
                                <input type="text" class="form-control" id="tahun_lupus" name="tahun_lupus" value="{{ $hmlupus->tahun_lupus }}" required>
                        </div><!--col-->
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control col-md-1" name="status" id="status" disabled>
                            <option value="{{ $hmlupus->status }}" selected>Lulus</option>
                        ...
                        <select class="form-control col-md-2" name="kaedah_lupus" id="kaedah_lupus">
                            <option value="{{ $hmlupus->kaedah_lupus }}" selected>{{ $hmlupus->kaedah_lupus }}</option>
                            <option value="" >Sila Pilih</option>
                            <option value="E-Waste">E-Waste</option>
                            <option value="Jualan Sisa">Jualan Sisa</option>
                            <option value="Musnah">Musnah</option>
