...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7">
                <form action="{{ route('admin.hartamodal') }}" method="GET" role="search">
                        ...
                        <tbody>
                            @foreach($hartamodals as $hartamodal)
                                ...
                                <tr>
                                    ...
                                    <td style="text-transform:uppercase">{{ $hartamodal->no_casis_siri_pembuat ?? null}}</td>
                                    ...
                                    <td style="text-transform:uppercase">{{ $hartamodal->status_alat->nama_status ?? null}}</td>
                                    <td>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a href="{{ route('admin.edithartamodal',[$hartamodal,'term'=>request('term') ?? null]) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="edit">
                                                ...
                                                @if ($hartamodal->status_alat->id < 5)
                                                <a href="{{ route('admin.aduanhartamodal',[$hartamodal,'term'=>request('term') ?? null]) }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="aduan">
