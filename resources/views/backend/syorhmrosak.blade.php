...
@section('title', __('Maklumat Syor Aduan Kerosakan (HM)'))

@section('content')

<form method="POST" action="{{ route('admin.updatesyor', [$hmrosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        Maklumat Syor Aduan Kerosakan (HM)
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Jumlah Kos Penyelenggaraan Terdahulu</b></label>
                            <div class="col-md-1">
                                <input type="text" class="form-control" id="kos_dulu" name="kos_dulu" value="{{ $hmrosak->kos_dulu ?? null}}">
                            </div><!--col-->

                            <label class="col-md-2 col-form-label"><b>Anggaran Kos Penyelenggaraan</b></label>
                            <div class="col-md-1">
                                <input type="text" class="form-control" id="kos_anggar" name="kos_anggar" value="{{ $hmrosak->kos_anggar ?? null}}">
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" value="{{ $hmrosak->statusrosak->nama_status ?? null}}" disabled>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Syor Dan Ulasan</b></label>
                            <div class="col-md">
                                <textarea class="form-control" id="syor" name="syor" required>{{ $hmrosak->syor ?? null}}</textarea>
                            </div><!--col-->
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            ...
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control" name="tahun" value="{{ $hmrosak->tahun ?? null }}" required>
