        ...
        <div class="row">
            <div class="col-sm-6">
                <h4 class="card-title mb-0">
                    Senarai Aduan Kerosakan Aset Tak Alih (Struktur) - Selesai
                </h4>
            </div><!--col-->
            ...
            <div class="col-sm-7">
                <form action="{{ route('admin.strrosak_selesai') }}" method="GET" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('admin.strrosak_selesai') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.showstrrosak_selesai',[$strrosak,'term'=>request('term') ?? null]) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="show">
