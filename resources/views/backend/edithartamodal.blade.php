...
<form method="POST" action="{{ route('admin.updatehartamodal',[$hartamodal,'term'=>request('term') ?? null]) }}">
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-1">
                            <input type="text" class="form-control" {{-- id="kos" name="kos" --}} value="{{ $hartamodal->kos ?? null}}" disabled>
                        </div><!--col-->
                    ...
                    <div class="form-group row">
                        ...
                        @if ($hartamodal->status_alat->id <= 4)
                        ...
                        @endif
                            ...
                            <option value="{{ $hartamodal->status_alat->id ?? null}}" style="text-transform:uppercase">{{ $hartamodal->status_alat->nama_status}}</option>
