        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $user->type }}'}">
                    ...
                    <div class="form-group row">
                        <label for="jawatan" class="col-md-2 col-form-label">@lang('Jawatan')</label>

                        <div class="col-md-10">
                            <input type="jawatan" name="jawatan" id="jawatan" class="form-control" placeholder="{{ __('Jawatan') }}" value="{{ old('jawatan') ?? $user->jawatan }}" maxlength="255" required />
                        </div>
                    </div><!--form-group-->
