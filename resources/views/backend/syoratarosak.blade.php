...
<form method="POST" action="{{ route('admin.updateatasyor', [$atarosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label"><b>Status</b></label>
                            ...
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control" name="tahun" value="{{ $atarosak->tahun ?? null }}" required>
