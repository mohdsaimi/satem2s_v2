...
<form method="POST" action="{{ route('admin.updateabrrosak', [$abrrosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
                        ...
                        <label class="col-md-1 col-form-label">PIC</label>
                            <div class="col-md-3">
                                <select class="form-control" name="user_asign" style="text-transform:uppercase" required>
                                    @if (empty($abrrosak->user_asign))
                                    <option value="">Sila Pilih</option>
                                    @else
                                    <option value="{{ $abrrosak->user_asign}}" style="text-transform:uppercase">{{ $abrrosak->nama_1->nama }}</option>
                                    @endif
