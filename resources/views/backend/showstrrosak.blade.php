...
<form method="POST" action="{{ route('admin.updatestrrosak', [$strrosak,'term'=>request('term') ?? null]) }}" {{-- enctype="multipart/form-data" --}}>
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        <label class="col-md-1 col-form-label">PIC</label>
                            <div class="col-md-3">
                                <select class="form-control" name="user_siasat" style="text-transform:uppercase" required>
                    ...
                    <div class="form-group row">
                        <label class="col-md-1 col-form-label">Jenis Kerja</label>
                            <div class="col-md-3">
                                <select class="form-control" name="jenis_kerja" style="text-transform:uppercase" required>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Keterangan</label>
                            <div class="col-md">
                                <textarea class="form-control" id="ulas_siasat" name="ulas_siasat" required>{{ $strrosak->ulas_siasat ?? null}}</textarea>
                            </div><!--col-->
                    </div>
